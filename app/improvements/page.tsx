      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Review and approve improvements suggested by the ProductImprovementAgent
          </p>
        </div>
        ...
        {improvements.length === 0 ? (
          <Card className="text-center py-12">
            ...
            <p className="text-slate-400 mb-4">No {filter !== 'all' ? filter : ''} improvements found</p>
            <p className="text-sm text-slate-500">
              Run the maestro-self-improvement-agent to generate suggestions
            </p>
          </Card>
        ) : (
